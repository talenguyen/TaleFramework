package com.tale.taleframework.ui;
...
public class FragmentNavigator {
    ...
    private FragmentNavigator(final BaseActivity activity, int fragmentContainerId) {
        this.fragmentContainerId = fragmentContainerId;
        this.fragmentManager = activity.getSupportFragmentManager();
    }

    public static FragmentNavigator create(BaseActivity activity, int fragmentContainerId) {
